...
const sizes = getDirSizes(root, []).sort((a, b) => a - b);

const updateSize = 30000000;
const totalSpace = 70000000;
const rootSize = sizes.at(-1);
const spaceNeeded = updateSize - (totalSpace - rootSize);

console.log(sizes.find(size => size >= spaceNeeded));