...
class Map
{
	...
	populate(paths)
	{
		...
		this.line(new Vec2(0, this.bounds.height - 1), new Vec2(this.bounds.width - 1, this.bounds.height - 1), "#");
	}
	...
	runSimulation()
	{
		...
		while(this.getBlock(this.sandSpawnPos) === ".")
		{
			this.simulateSand(this.sandSpawnPos.copy());
			++sandBlocks;
		}
